...
namespace SkillCypher.Infrastructure.Migrations
{
    ...
    [Migration("20260516000000_AddRequiredExperienceToJobs")]
    partial class AddRequiredExperienceToJobs
    {
            ...
            modelBuilder.Entity("SkillCypher.Core.Models.Applicant", b =>
                {
                    b.HasOne("SkillCypher.Core.Models.User", "user")
                        .WithOne("applicant")
                        .HasForeignKey("SkillCypher.Core.Models.Applicant", "UserId")
            ...
            modelBuilder.Entity("SkillCypher.Core.Models.ApplicantCertificate", b =>
                {
                    ...
                    b.HasOne("SkillCypher.Core.Models.Certificate", "certificate")
                        .WithMany("applicant_certificates")
            ...
            modelBuilder.Entity("SkillCypher.Core.Models.Certificate", b =>
                {
                    ...
                    b.Navigation("applicant_certificates");
                });
